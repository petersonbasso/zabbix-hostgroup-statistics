...
A monitoria cria 1 application para cada grupo retornado pela regra de descoberta, cada application possui 3 itens [Hosts Total, Hosts UP, Hosts Down] representando um status resumido daquele grupo.
